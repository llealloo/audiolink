...
const static uint2 bitmapFont[96] = {
    ...
    {  9586944,   9586944 }, // 5  37 '%' // 1001 0010 0100 1001 0000 0000
    ...
    {  6928496,   6928496 }, // 32 64 '@' // 0110 1001 1011 1000 0111 0000
    ...
    {  6571104,   6571104 }, // 59 91 '[' // 0110 0100 0100 0100 0110 0000
    {  8929824,   8929824 }, // 60 92 '\' // 1000 1000 0100 0010 0010 0000
    {  6431328,   6431328 }, // 61 93 ']' // 0110 0010 0010 0010 0110 0000
    ...
    {  8650752,   8650752 }, // 64 96 '`' // 1000 0100 0000 0000 0000 0000
    ...
    {  3293744,   3293744 }, // 91 123 '{' // 0011 0010 0100 0010 0011 0000
    {  4473920,   4473920 }, // 92 124 '|' // 0100 0100 0100 0100 0100 0000
    { 12854464,  12854464 }, // 93 125 '}' // 1100 0100 0010 0100 1100 0000
    {    23040,     23040 }, // 94 126 '~' // 0000 0000 0101 1010 0000 0000
...
float PrintChar(uint charNum, float2 charUV, float2 softness, float offset)
{
    ...
    charUV += float2(0, 0.5);
    // The table only covers ASCII 32-127. Global strings carry full UTF-32 codepoints
    // and player display names are routinely non-ASCII, so charNum can legitimately land
    // outside that range - fall back to the blank glyph rather than reading out of bounds.
    // Note charNum is unsigned, so anything below 32 would underflow the subtraction.
    uint charIndex = (charNum < 32 || charNum > 127) ? 0 : charNum - 32;
    uint2 bitmap = bitmapFont[charIndex];
