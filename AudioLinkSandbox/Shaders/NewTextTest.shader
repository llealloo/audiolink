...
float PrintChar(uint selChar, float2 charUV, float2 softness)
{
    ...
    const static uint2 bitmapNumberFont[85] = {
        ...
        {   961760,    961776 }, // 62  'e' // 0000 1110 1010 1100 1110 0000      0000 1110 1010 1100 1111 0000
        {  6612032,   6612032 }, // 63  'f' // 0110 0100 1110 0100 0100 0000      0110 0100 1110 0100 0100 0000
        {   976608,    960224 }, // 64  'g' // 0000 1110 1110 0110 1110 0000      0000 1110 1010 0110 1110 0000
        ...
        {  2108128,   2370272 }, // 67  'j' // 0010 0000 0010 1010 1110 0000      0010 0100 0010 1010 1110 0000
