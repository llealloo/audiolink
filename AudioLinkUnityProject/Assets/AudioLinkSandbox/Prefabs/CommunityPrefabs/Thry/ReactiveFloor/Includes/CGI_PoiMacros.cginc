    ...
    //#define POI2D_SAMPLER_PAN2(tex, texSampler, uvIndex, pan) (UNITY_SAMPLE_TEX2D_SAMPLER(tex, texSampler, uvIndex > 4 ? (saturate(poiMesh.uv[uvIndex].xy + tex##_ST.zw) * tex##_ST.xy) : TRANSFORM_TEX(poiMesh.uv[uvIndex], tex) + _Time.x * pan))
