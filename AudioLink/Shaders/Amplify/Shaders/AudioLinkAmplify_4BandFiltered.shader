...
Shader "AudioLink/Amplify/AudioLinkAmplify_4BandFiltered"
{
	...
	LOD 100
		...
		Pass
		{
			...
			inline float AudioLinkLerp3_g2( int Band, float FilteredAmount )
			{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				int Band3_g2 = (int)_Band;
				float FilteredAmount3_g2 = ( _FilterLevel * 15.0 );
				float localAudioLinkLerp3_g2 = AudioLinkLerp3_g2( Band3_g2 , FilteredAmount3_g2 );
				float lerpResult56 = lerp( localAudioLinkLerp3_g5 , localAudioLinkLerp3_g2 , _FilterAmount);
...
/*ASEBEGIN
Version=18908
3125.6;142.4;2254;1199;708.2083;294.442;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;58;300.9054,253.7296;Inherit;False;4BandAmplitudeFiltered;-1;;2;3e18e71c60559ad419be81278157ae18;0;2;2;INT;0;False;4;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=38E21DF433A616844040889CE7430A33EC6815B4