...
#define _Emission_arr AudioLinkSurfaceAudioReactiveSurface_SmoothAlpha
				...
				) : SV_Target 
			{
				...
				float2 break6_g6 = texCoord50;
				float temp_output_5_0_g6 = ( break6_g6.x - 0.5 );
				float _PulseRotation_Instance = UNITY_ACCESS_INSTANCED_PROP(_PulseRotation_arr, _PulseRotation);
				float temp_output_2_0_g6 = radians( _PulseRotation_Instance );
				float temp_output_3_0_g6 = cos( temp_output_2_0_g6 );
				float temp_output_8_0_g6 = sin( temp_output_2_0_g6 );
				float temp_output_20_0_g6 = ( 1.0 / ( abs( temp_output_3_0_g6 ) + abs( temp_output_8_0_g6 ) ) );
				float temp_output_7_0_g6 = ( break6_g6.y - 0.5 );
				float2 appendResult16_g6 = (float2(( ( ( temp_output_5_0_g6 * temp_output_3_0_g6 * temp_output_20_0_g6 ) + ( temp_output_7_0_g6 * temp_output_8_0_g6 * temp_output_20_0_g6 ) ) + 0.5 ) , ( ( ( temp_output_7_0_g6 * temp_output_3_0_g6 * temp_output_20_0_g6 ) - ( temp_output_5_0_g6 * temp_output_8_0_g6 * temp_output_20_0_g6 ) ) + 0.5 )));
				...
				float Delay3_g5 = ( (_Delay_Instance + (( appendResult16_g6.x * _Pulse_Instance ) - 0.0) * (1.0 - _Delay_Instance) / (1.0 - 0.0)) % 1.0 );
...
Node;AmplifyShaderEditor.FunctionNode;69;-1717.011,753.3173;Inherit;False;RotateUVFill;-1;;6;459952d587cbfe742a7e7f4a8a0a4169;0;2;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=D99A994DD7EADA1C23A388CC9A0C69275E79BD47