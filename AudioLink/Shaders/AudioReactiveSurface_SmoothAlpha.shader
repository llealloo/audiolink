...
#define _Emission_arr AudioLinkSurfaceAudioReactiveSurface_SmoothAlpha
				...
				) : SV_Target 
			{
				...
				float Delay3_g5 = ( ( (_Delay_Instance + (( appendResult16_g6.x * _Pulse_Instance ) - 0.0) * (1.0 - _Delay_Instance) / (1.0 - 0.0)) % 1.0 ) * 128.0 );
...
/*ASEBEGIN
Version=18908
3072;0.8;2439;976;2827.056;-127.7362;1.305492;True;False
...
Node;AmplifyShaderEditor.FunctionNode;69;-1916.752,755.9283;Inherit;False;RotateUVFill;-1;;6;459952d587cbfe742a7e7f4a8a0a4169;0;2;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;93;-1442.31,890.3558;Inherit;False;BandPulse;-1;;7;c478702160369ce4480fa2fb6d734ffa;0;3;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=84BD4CB43CBE0009F7369065F8F175202075B081